    ...
    var body: some View {
        ScrollView {
            VStack {
                ...
                Divider()
                Group {
                    Text("Vul de gages in die je hebt gekregen voor het optreden met de categorie die je hebt gekozen. Je kunt kiezen uit verschillende type optredens en grootte van shows. Deze app is om een gemiddelde te bepalen van alle gages van verschillende type optredens en muzikanten. Je kunt filteren op jaren ervaring, maximum en minimum gages etc. Alle gegevens worden ANONIEM verzameld. Je naam of contactgegevens komen nergens in de data voor. De gegevens zijn het meest bruikbaar als iedereen alles zo goed als mogelijk invult. Je kunt Wage ook gebruiken om een overzicht van al je eigen gages te krijgen")
                        .fontWeight(.thin)
        ...
        .background(LinearGradient(colors: [Color("blueIsh"),Color("toolbar"),Color("blueIsh")], startPoint: .topLeading, endPoint: .bottomTrailing))
    }
}
